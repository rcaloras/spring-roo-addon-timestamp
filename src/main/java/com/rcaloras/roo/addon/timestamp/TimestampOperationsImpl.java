...
public class TimestampOperationsImpl implements TimestampOperations {
    ...
    public void setup() {
        ...
        projectOperations.addRepository("", new Repository("Timestamp Roo add-on repository", "Timestamp Roo add-on repository", "https://com-rcaloras-addon-timestamp.googlecode.com/svn/repo"));
        
        List<Dependency> dependencies = new ArrayList<Dependency>();
        
        // Install the dependency on the add-on jar (
        dependencies.add(new Dependency("com.rcaloras.addon.timestamp", "com.rcaloras.addon.timestamp", "0.1.0.BUILD-SNAPSHOT", DependencyType.JAR, DependencyScope.PROVIDED));
