...
public class TimestampOperationsImpl implements TimestampOperations {
    ...
    public void setup() {
        ...
        dependencies.add(new Dependency("com.rcaloras.roo.addon.timestamp", "com.rcaloras.roo.addon.timestamp", "0.1.1-SNAPSHOT", DependencyType.JAR, DependencyScope.PROVIDED));
